...
*/ Tried changing Brian's as little as possible so I commented out lines of his that I changed with notes.
*/
...
//		return DATA;                  chgd to return results (both tallies and errors) -lp
	...
	public static Mat chkRotate(Mat Image)
	{
	 ...
	 public static void main( String[] args )
	   {
		 //Simple dummy main for testing, it loads an image on my desktop for processing
